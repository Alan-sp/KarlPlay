    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(ui->slider_pos,QOverload<int>::of(&QSlider::valueChanged),this,&MainWindow::onSliderValueChanged);
...
void MainWindow::on_btn_openlist_clicked()
{
...
void MainWindow::on_btn_closelist_clicked()
{
...
void MainWindow::onSliderValueChanged(int pos)
{
